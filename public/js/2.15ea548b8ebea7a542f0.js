...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    inputEvent: function inputEvent(q) {
      this.nuxts.filter(function (item) {
