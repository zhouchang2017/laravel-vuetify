          ...
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _this3.nuxts.forEach(function (item) {
                _this3.$set(_this3.$data, 'tab-' + item.id, {
                  avatar: '',
                  title: ''
                });
              });
