              ...
              _c(
                ...
                [
                  _c("v-select", {
                    ...
                    model: {
                      value: _vm.formData.banners.id,
                      callback: function($$v) {
                        _vm.$set(_vm.formData.banners, "id", $$v)
                      },
                      expression: "formData.banners.id"
                    }
                  })
                ],
                1
