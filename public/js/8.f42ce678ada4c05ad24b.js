...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPath: function getPath(src) {
      this.formDate.banner.avatar = src;
    },
                  ...
                  _c("v-text-field", {
                    attrs: {
                      ...
                      rules: [
                        function() {
                          return (
                            !!_vm.formDate.nuxt.name || "client is required!!"
                          )
                        }
                      ],
                      counter: 32,
                    ...
                    model: {
                      value: _vm.formDate.nuxt.name,
                      callback: function($$v) {
                        _vm.$set(_vm.formDate.nuxt, "name", $$v)
                      },
                      expression: "formDate.nuxt.name"
                    }
                  }),
                  _vm._v(" "),
                  _c("v-text-field", {
                    attrs: {
                      ...
                      rules: [
                        function() {
                          return (
                            !!_vm.formDate.nuxt.prefix || "prefix is required!!"
                          )
                        }
                      ],
                      counter: 10,
                    ...
                    model: {
                      value: _vm.formDate.nuxt.prefix,
                      callback: function($$v) {
                        _vm.$set(_vm.formDate.nuxt, "prefix", $$v)
                      },
                      expression: "formDate.nuxt.prefix"
                    }
                  })
                ],
                1
                  ...
                  _c("v-text-field", {
                    attrs: {
                      ...
                      rules: [
                        function() {
                          return (
                            !!_vm.formDate.banner.title || "title is required!!"
                          )
                        }
                      ],
                      counter: 32,
                    ...
                    model: {
                      value: _vm.formDate.banner.title,
                      callback: function($$v) {
                        _vm.$set(_vm.formDate.banner, "title", $$v)
                      },
                      expression: "formDate.banner.title"
                    }
                  }),
                  _vm._v(" "),
                  _c(
