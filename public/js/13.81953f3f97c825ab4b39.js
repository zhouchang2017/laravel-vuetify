...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("v-divider"),
      _vm._v(" "),
      _c("banner-create", { attrs: { editData: _vm.body } })
    ],
    1
  )
}
